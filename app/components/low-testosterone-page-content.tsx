...
const IMG = (file: string) => `/images/hormone replacement therapy/${file}`;

/** Weight / body-composition imagery (matches clinical weight-management section). */
const WEIGHT_IMG = encodeURI(
  "/images/weight loss/Untitled+design+(7)-1600h.png",
);
  ...
  return (
    ...
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M9.813 15.904L9 18.75l-1.813-2.846a4.5 4.5 0 01-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09zM18.259 8.715L18 9.75l-.259-1.035a3.375 3.375 0 00-2.455-2.456L14.25 6l1.036-.259a3.375 3.375 0 002.455-2.456L18 2.25l.259 1.035a3.375 3.375 0 002.456 2.456L21.75 6l-1.035.259a3.375 3.375 0 00-2.456 2.456zM16.894 20.567L16.5 21.75l-.394-1.183a2.25 2.25 0 00-1.423-1.423L13.5 18.75l1.183-.394a2.25 2.25 0 001.423-1.423l.394-1.183.394 1.183a2.25 2.25 0 001.423 1.423l1.183.394-1.183.394a2.25 2.25 0 00-1.423 1.423z"
      />
    </svg>
  );
}
...
export function LowTestosteronePageContent() {
  return (
      ...
      <section className="rounded-t-3xl border-t border-slate-200 bg-white">
        ...
        <div className="bg-[#E5E5E5] px-6 py-14 md:py-16">
          <div className="mx-auto max-w-4xl text-center text-slate-900">
            <p className="text-base font-semibold leading-relaxed md:text-lg">
              Hormones protect and prevent risks of age related diseases.
              Optimizing your hormones has proven to lessen the likelihood of
              Osteoporosis, Alzheimer&apos;s, Diabetes, Heart Disease, Impaired
              Vision and Many Cancers.
            </p>
            ...
            <ul className="grid grid-cols-1 gap-x-8 gap-y-10 sm:grid-cols-2 lg:grid-cols-3">
              {SYMPTOMS.map(({ label, Icon }) => (
                <li key={label} className="flex items-start gap-4">
                  ...
                  <span className="pt-1 text-base font-bold leading-snug text-slate-900">
                    {label}
                  </span>
                </li>
              ))}
        ...
        <section className="border-t border-slate-200 bg-white px-6 py-14 md:py-20">
          <h2 className="text-center text-2xl font-bold tracking-tight text-slate-900 md:text-3xl">
            Low Testosterone Treatment San Antonio
          </h2>
          <div className="mx-auto mt-12 grid max-w-6xl gap-10 lg:grid-cols-2 lg:items-center lg:gap-14">
            ...
            <div className="space-y-6 text-base font-light italic leading-relaxed text-slate-800">
              <p>
                Research shows that balancing and optimizing your hormones makes
                you feel happier and younger. At The Urology Place we have
                Board Certified physicians that can assess your health and after
                one simple blood test, can restore your vitality!
              </p>
              <p>
                We offer different modalities of treatment all based on your
                unique needs and goals. Most commonly we recommend Hormone Pellets
                as they ensure the most effective optimization, assist with
                symptom relief and give patients the greatest freedom without
                having to remember to take a medication, cream or injection.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="mx-auto mt-14 max-w-6xl space-y-20 md:space-y-24">
            <div className="grid gap-10 lg:grid-cols-2 lg:items-center lg:gap-14">
              <div>
                ...
                <p className="mt-5 text-sm font-normal leading-relaxed text-slate-600">
                  ...
                  usually given once a week or every two weeks. The levels sharply
                  spike after injection. Levels of testosterone rise above the
                  normal range within the first 48 hours and fall below the
                  normal range in the days prior to the next dose. This
                  supra-physiologic rise and fall can be a matter of concern.
                </p>
              </div>
            ...
            <div className="grid gap-10 lg:grid-cols-2 lg:items-center lg:gap-14">
              ...
              <div className="order-1 lg:order-2">
                ...
                <p className="mt-5 text-sm font-normal leading-relaxed text-slate-600">
                  This is a painless way of applying testosterone. Transdermal
                  testosterone formulations (patches, gels) can have
                  limitations, such as local reactions, poor adhesion, fear of
                  transmission to others, unpleasant odor, and high discontinuation
                  rates.
                </p>
              </div>
            </div>
        ...
        {/* Pellets (pricing block follows video + weight section) */}
        <section className="border-t border-slate-200 bg-white px-6 py-14 md:py-20">
          <div className="mx-auto grid max-w-6xl gap-10 lg:grid-cols-2 lg:items-center lg:gap-14">
            <div>
              ...
              <p className="mt-5 text-sm font-normal leading-relaxed text-slate-700">
                Testosterone pellets are bio-identical. In other words, it is the
                same type of testosterone as your body makes. Pellets can last
                for months at a time and have the benefit of holding steady
                levels. As a result, the erratic swings with other modes of
                therapy are avoided. The pellets are placed in the physician&apos;s
                office in a 5–10 minute procedure. The pellets are shaped like
                large grains of rice and are placed in the upper hips or
                buttocks. Patients may experience soreness for a couple of days.
                It is a procedure, so there is a small risk of infection. The
                procedure itself is usually painless. Pellets are sourced from FDA
                registered 503B facilities. The sterile pellets are derived from
                yams, irradiated with E-beams to sterilize, and are in compliance
        ...
        {/* Video + testosterone & weight + pricing + cards */}
        <section className="border-t border-slate-200 bg-slate-100/80 px-6 py-14 md:py-20">
          <div className="mx-auto max-w-6xl">
            <div className="grid gap-0 overflow-hidden rounded-2xl shadow-md ring-1 ring-slate-200/80 lg:grid-cols-2">
              ...
              <div className="flex flex-col justify-center bg-sky-700 px-8 py-10 text-white sm:px-10 md:py-12">
                ...
                <p className="mt-4 text-sm leading-relaxed text-white/95 md:text-base">
                  Physician&apos;s assistant, Sho Grant, shares information about
                  the benefits behind Bioidentical Pellets. This is a quick
                  treatment that is done in our office that provides long-lasting
                  effects compared to other hormone optimization therapy options.
                </p>
              </div>
            </div>
            ...
            <div className="mt-12 rounded-2xl border border-slate-200/90 bg-[#E8E8E8] px-6 py-10 shadow-sm md:px-10 md:py-12">
              <div className="mx-auto grid max-w-6xl gap-10 lg:grid-cols-2 lg:items-center lg:gap-14">
                <div>
                  <h3 className="font-serif text-2xl font-bold tracking-tight text-blue-700 md:text-[1.65rem]">
                  ...
                  <p className="mt-4 text-[15px] leading-relaxed text-slate-800 md:text-base">
                    After 11 years of data collection, researchers found that
                    testosterone therapy had proven a significant benefit in
                    weight loss. They noted individuals in the T-group losing an
                    average of 20% bodyweight, whereas controls increased by 6%.
                  </p>
                  <div className="mt-8">
                    <Link
                ...
                <div className="relative aspect-[4/3] w-full overflow-hidden rounded-xl bg-slate-300 ring-1 ring-slate-300/80 shadow-sm">
                  <Image
                    src={WEIGHT_IMG}
                    alt="Medical scale and healthy weight management"
                    fill
                    className="object-cover"
                    sizes="(min-width: 1024px) 45vw, 100vw"
                  />
            ...
            <div className="mx-auto mt-14 max-w-3xl text-center">
              ...
              <p className="mt-6 text-base font-normal leading-relaxed text-slate-700">
                At the Urology Place we offer competitive pricing for Hormone
                Replacement Therapy. Our providers are experts in Hormone
                Optimization and offer treatment significantly cheaper than our
                competitors.
              </p>
            </div>
            ...
            <div className="mt-12 grid gap-6 md:grid-cols-3">
              ...
              <div className="relative flex flex-col rounded-2xl border border-slate-200 bg-white px-6 pb-8 pt-10 text-center shadow-md ring-1 ring-slate-100">
                <div
                  className="absolute inset-x-0 top-0 h-1 rounded-t-2xl bg-emerald-500"
                  aria-hidden
                />
                <h4 className="text-lg font-bold text-slate-900">
                  Female Pelleting
        ...
        {/* FAQ — same accordion as Women / Hormone Replacement Therapy */}
